---
title: 'Working Notebook: Emergency Fund Modeling with NFCS Data'
...
- Education, 
- Debt level, 
- Budgeting behaviors, and 
- Other personal characteristics, e.g. children, married versus single.
...
File contains 126 variables for 27,118 observations.  Saved uncleaned and untransformed data as `source.Rdata` in the `./data` folder.
